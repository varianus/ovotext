...
$Id: SynEditPrint.pas,v 1.3 2000/09/27 20:39:49 mghie Exp $
...
type
  ...
  private
    ...
    FPageOffset: Integer;
    FRangesOK: Boolean;
//    FTestString: string;                                                      //sb 2000-09-23
    FMaxWidth: integer;                                                         //sb 2000-09-23
    FMaxCol: Integer;
    FPagesCounted: Boolean;
    FLineNumbersInMargin: Boolean;
    FTabWidth: integer;                                                         //sb 2000-09-23
    procedure CalcPages;
