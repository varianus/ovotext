...
$Id: SynExportRTF.pas,v 1.1.1.1 2000/07/08 15:54:05 mghie Exp $
...
begin
  ...
  if BackgroundChanged or fUseBackground then begin
    AddData(Format('\chshdng0\chcbpat%0:d\cb%0:d', [GetColorIndex(fLastBG)]));
    fAttributesChanged := TRUE;
  end;
